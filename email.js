...
function sendPasswordResetMail(req,res,next){
    ...
    var userName = req.body.userName
    var toMailAddress = req.body.toMailAddress
    var messageText = "<html><body><p>Dear "+ userName + "</p><p>To reset your password please click the link.</p><a href=" + linktoreset  + ">Click to reset</a><p>We would love to assist you in any kind of questions so do not hesitate to contact us.</p><p>Best Regards,</P><p>Upvote Team</p></body></html>"
